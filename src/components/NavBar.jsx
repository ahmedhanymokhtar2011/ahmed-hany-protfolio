            ...
            <div className='container flex items-center justify-between'>
                <a className='text-xl font-bold text-primary flex items-center' href='#hero'>
                    <span className='relative z-10'>
                        {""}
                        <span className='text-glow text-foreground'>Ahmed hany</span> portfolio
                    </span>
                </a>
                {/*desktop nav */}
                ...
                <div className={cn("fixed top-0 right-0 h-screen w-3/4 max-w-xs bg-background/95 backdrop-blur-md z-40 flex flex-col items-center justify-center",
